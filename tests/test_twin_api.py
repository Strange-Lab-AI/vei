...
def test_guardrail_payload_can_hold_safe_write_for_approval(
    tmp_path: Path,
) -> None:
    root = tmp_path / "service_ops_guardrail_approval"
    bundle = build_customer_twin(
        root,
        snapshot=_sample_snapshot(),
        organization_domain="clearwater.example.com",
            ...
            json={
                ...
                "payload": {
                    "guardrail": {
                        ...
                        "reason": "Incident-related outward explanation requires legal review before it is sent.",
                    }
                },
            },
        )
